...
master_image_router = APIRouter(prefix='')
...
@master_image_router.post('/api/direct_use_pic', response_class=JSONResponse)
...
@master_image_router.post('/api/download_pic', response_class=JSONResponse)
...
@master_image_router.post('/api/upload_pic')
...
@master_image_router.post('/api/upload_temp_pic')
async def upload_pic(image: UploadFile):
    image_id = str(id_worker.next_id())
...
@master_image_router.get('/api/page_temp_image')
